...
namespace HikingGear.Migrations
{
    ...
    [Migration("20220821001621_AuthorizeCategories")]
    partial class AuthorizeCategories
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HikingGear.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HikingGear.Models.Category", b =>
                {
                    b.HasOne("HikingGear.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HikingGear.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
